...
let generateHTML = (product) => `
    <div class="group w-[280px] border border-[#EEEEEE] p-[15px] text-center bg-[#EEEEEE] rounded-[8px] transition-all duration-300 ease-in-out inline-block m-[10px] hover:-translate-y-[10px] hover:shadow-[0_10px_20px_rgba(0,0,0,0.15)] hover:cursor-pointer hover:border-[#EEEEEE]">
        ...
        <p class="price-row">
            ${product.oldPrice ? `<span class="old-price line-through text-[grey] mr-[10ox]">Rs. ${product.oldPrice}</span>` : ''}
